...
void print_flag4x3(HPDF_Doc pdf, HPDF_Page page, HPDF_Font font)
{
    HPDF_REAL height = HPDF_Page_GetHeight (page);
    HPDF_REAL width = HPDF_Page_GetWidth (page);
		...
		float* arrecgV1, float* arrecgV2, float* arrecgV3, float* arrecgV4, float* arrecgV5, float* arrecgV6)
{
	...
	if(gPrintInfo.printtype == 0){
		...
		print_flag4x3(pdf, page, font);
		drawcurve_column1(pdf, page, arrecgI, len, 5);
		drawcurve_column1(pdf, page, arrecgII, len, 3);
		drawcurve_column1(pdf, page, arrecgIII, len, 1);
		drawcurve_column2(pdf, page, arrecgaVR, len, 5);
